...
function CampoLogin({ icon, rightIcon, onRightIconPress, style, editable = true, onFocus, ...props }) {
...
export default function TelaLogin({
  ...
  const handleInputFocus = (offset = 80) => {
    setTimeout(() => {
  ...
  return (
    <View style={[estilosLogin.containerPrincipal, { backgroundColor: colors.background || "#000000" }]}>
      <StatusBar barStyle="light-content" backgroundColor="#000000" />

      <View style={estilosLogin.ambientGlow} />
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          contentContainerStyle={[
            estilosLogin.scrollContent,
            {
              justifyContent: keyboardVisible ? "flex-start" : "center",
              paddingTop: Math.max(insets.top, 20) + (keyboardVisible ? 12 : 20),
          ...
          <Animated.View
            style={[
              ...
              {
                opacity: animValue,
                marginBottom: keyboardVisible ? 14 : 24,
                transform: [
            ...
            <Ionicons name="people" size={keyboardVisible ? 36 : 44} color="#FFFFFF" />
            <Text style={[estilosLogin.logoTexto, keyboardVisible && { fontSize: 30 }]}>Tribo</Text>
          </Animated.View>
