        ...
        <FlatList
          ...
          ListHeaderComponent={() => {
            return (
              <View style={styles.headerBlock}>
                {/* SEÇÃO DE DESTAQUES EM VÍDEO (YOUTUBE) */}
                  ...
                  <View style={styles.videosSection}>
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => (
                        ...
                        >
                          {/* Thumbnail com Overlay e Botão de Play */}
          ...
          renderItem={({ item, index }) => {
            return (
              ...
              >
                {/* Linha de Ranking, Fonte e Tempo */}
                ...
                {/* Título da Notícia (Limpo, sem imagens) */}
                ...
                {/* Rodapé do Item: Engajamento / Categoria */}
