    ...
    >
      <View style={estilosVerificacao.rewardOverlay}>
        <View style={estilosVerificacao.rewardCard}>
          ...
          <Text style={estilosVerificacao.rewardTitle}>
            Conta verificada com sucesso!
          </Text>
          <Text style={estilosVerificacao.rewardMessage}>
            Verificamos seu e-mail! Você acaba de ganhar o Selo de Verificação
            no seu perfil.
          </Text>
          <Pressable
            onPress={onContinuar}
            style={estilosVerificacao.rewardButton}
          >
    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <Text
            style={{ flex: 1, color: "#FFFFFF", fontSize: 13, lineHeight: 18 }}
          >
            Não encontrou o código? Verifique a caixa de Spam ou Lixo
            Eletrônico.
          </Text>
        </View>
        ...
        >
          ...
          <Text
            style={[estilosVerificacao.verifyEmailText, { color: colors.text }]}
          >
            {email}
          </Text>
        </View>
        ...
        <View style={estilosVerificacao.resendContainer}>
          <Text
            style={[estilosVerificacao.resendPrompt, { color: colors.muted }]}
          >
          ...
          <Pressable
            disabled={reenviando}
            onPress={onReenviar}
            style={estilosVerificacao.resendButton}
          >
            <Text
              style={[estilosVerificacao.resendText, { color: colors.primary }]}
            >
        ...
        <Pressable
          ...
          style={estilosVerificacao.backToLogin}
        >
          <Feather name="arrow-left" size={16} color={colors.muted} />
          <Text
            style={[
              estilosVerificacao.backToLoginText,
              { color: colors.muted },
            ]}
          >
            Voltar para o login
