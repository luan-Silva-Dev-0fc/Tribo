...
export function ReelsScreen({ user }) {
  ...
  const loadPreferencesAndCategories = useCallback(async () => {
    try {
      ...
      console.warn("[ReelsScreen] Erro ao carregar preferências:", err.message);
    }
  }, []);
  ...
  const loadFeed = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      console.warn("[ReelsScreen] Erro ao carregar feed de reels:", err.message);
  ...
  const handleLoadMore = useCallback(async () => {
    ...
    try {
      ...
      console.warn("[ReelsScreen] Erro ao carregar mais reels:", err.message);
    } finally {
  ...
  const handleToggleLike = useCallback(
    async (videoId, category) => {
      try {
        ...
        console.warn("[ReelsScreen] Falha no like:", err.message);
      }
    },
    [showToast]
  );
  ...
  const handleMoreLikeThis = useCallback(
    async (videoId, category) => {
      try {
        ...
        console.warn("[ReelsScreen] Falha no more-like-this:", err.message);
      }
    },
    [showToast]
  );
  ...
  const handleNotInterested = useCallback(
    async (videoId, category) => {
      try {
        ...
        console.warn("[ReelsScreen] Falha no not-interested:", err.message);
      }
    },
    [showToast]
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <SavedReelsModal
        ...
        onSelectReel={(item) => handleSelectFromSearch(item)}
      />
...
export const TelaReels = ReelsScreen;
